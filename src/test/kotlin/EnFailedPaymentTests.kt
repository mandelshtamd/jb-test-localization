...
class EnFailedPaymentTests {
    ...
    fun fakeDataPersonalTest() {
        ...
        correctAnswer.append("<html>\n" +
                ...
                "    <p>To ensure uninterrupted access to your subscription, please follow the link and renew your subscription <a href=\"https://foo.bar/ex\">manually</a> till Apr 13, 2021</p>\n" +
    ...
    fun fakeDataOrganisationTest() {
        ...
        correctAnswer.append("<html>\n" +
                ...
                "    <p>To ensure uninterrupted access to your subscriptions, please follow the link and renew your subscriptions <a href=\"https://foo.bar/ex\">manually</a> till Apr 13, 2021</p>\n" +
                "    <p>You can double-check and try your existing payment card again, use another card, or choose a different payment method.</p>\n" +
                "  </body>\n" +
                "</html>\n")
        assertEquals(StringBuilder().appendHTML().html { email.buildContent(this) }.toString(), correctAnswer.toString())
